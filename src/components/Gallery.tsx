      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="font-display font-extrabold text-3xl sm:text-5xl text-white uppercase tracking-tight">
            GLOBAL <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-500 font-black">SANCTUARY GALLERY</span>
          </h2>
        ...
        <div className="mt-14 text-center">
          <p className="text-zinc-550 font-mono text-xs uppercase tracking-widest font-semibold">
            *All photographs are taken in GLOBAL GYM Bazar Samiti branch premises. Come take your free physical tour!
          </p>
        </div>
