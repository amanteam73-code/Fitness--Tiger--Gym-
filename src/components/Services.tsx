...
export default function Services() {
  ...
  const getInquiryUrl = (serviceName: string) => {
    const text = encodeURIComponent(`Hi GLOBAL GYM! I'm interested in enrolling in the "${serviceName}" program at your Patna gym. Could you please share slot timings and coach fees?`);
    return `https://wa.me/919955542052?text=${text}`;
  };
