...
export default function Trainers() {
  ...
  const handleBookSubmit = (e: FormEvent) => {
    ...
    setTimeout(() => {
      const text = encodeURIComponent(`Hi GLOBAL GYM! I'm ${bookName}. I would like to book my FREE 1-on-1 personal training orientation slot with ${selectedTrainer?.name}. Goal: ${bookGoal}. Phone: ${bookPhone}. Please confirm!`);
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="flex justify-between items-start mb-6">
                <div>
                  <span className="text-[10px] font-mono uppercase text-cyan-400 tracking-widest font-extrabold">GLOBAL GYM VIP Trial Lab</span>
              ...
              {sessionBooked ? (
                ...
                <form onSubmit={handleBookSubmit} id="trainer-book-form" className="space-y-4">
                  ...
                  <p className="text-[10px] text-zinc-500 text-center leading-relaxed mt-2 uppercase tracking-tight">
                    *Limited to 1 trial orientation per person. No hidden costs. GLOBAL GYM Patna guarantees client data privacy.
                  </p>
